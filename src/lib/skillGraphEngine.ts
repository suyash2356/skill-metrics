...
export function matchDomainToSkillGraph(skillName: string): string | null {
  const domainMappings: Record<string, string[]> = {
    ...
    'Computer Applications': ['computer applications', 'computer basics', 'office productivity', 'it fundamentals', 'computer literacy'],
    ...
    'Economics': ['economics', 'microeconomics', 'macroeconomics', 'econometrics', 'economic theory'],
    'Finance': ['finance', 'financial', 'accounting', 'investment', 'stock market'],
    'Business': ['business', 'entrepreneurship'],
    'Management': ['management', 'leadership', 'project management'],
    'Human Resources': ['human resources', 'hr', 'talent acquisition', 'recruitment', 'people management', 'hris'],
    'Marketing': ['marketing'],
    ...
    'Interior Design': ['interior design', 'interior', 'space planning', 'interior decorator'],
    ...
    'Culinary Arts': ['culinary arts', 'culinary', 'cooking', 'chef', 'baking', 'gastronomy'],
    'Psychology': ['psychology', 'behavioral science'],
    'Philosophy': ['philosophy', 'ethics', 'logic', 'metaphysics'],
    'Political Science': ['political science', 'politics', 'international relations', 'geopolitics', 'governance'],
    'Social Work': ['social work', 'community development', 'case management', 'social welfare'],
    'Education': ['education', 'teaching', 'pedagogy', 'instructional design', 'curriculum'],
    'Environmental Science': ['environmental science', 'environment', 'ecology', 'climate change', 'sustainability'],
    'Health & Fitness': ['health', 'fitness', 'nutrition', 'exercise', 'wellness', 'personal training'],
