...
import { GraduationCap, ChevronRight, Package, Globe, Plus } from 'lucide-react';
...
const ExamList = ({ resources, onExamSelect, onAddResource }: ExamListProps) => {
  ...
  if (examStats.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground mb-4">Add exam prep resources to see exams listed here.</p>
