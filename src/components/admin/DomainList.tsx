...
const DomainList = ({ resources, onDomainSelect, onAddResource }: DomainListProps) => {
  ...
  if (domainStats.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground mb-4">Add resources to see domains listed here.</p>
