                ...
                {blogsLoading ? (
                        ...
                        {blogsAndPapers.filter(item => item.type === 'research_paper').slice(0, 6).map((item: any, i) => (
                          ...
                          >
                            <Card
                              ...
                              className="cursor-pointer bg-card hover:bg-card/80 border border-border/50 hover:border-violet-500/30 shadow-sm hover:shadow-lg transition-all h-[220px] flex flex-col group"
                            >
                              <CardHeader className="flex flex-row items-start gap-3 p-4 pb-2">
                              ...
                              <CardContent className="flex-1 flex flex-col justify-between p-4 pt-0">
                                ...
                                <div className="space-y-2 mt-2">
                                  {item.matchReason && (
                                    <Badge className="text-[10px] bg-violet-500/10 text-violet-600 border-0">
                                      {item.matchReason}
                                    </Badge>
                                  )}
                      ...
                      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {blogsAndPapers.filter(item => item.type === 'blog').slice(0, 9).map((item: any, i) => (
                          ...
                          >
                            <Card
                              onClick={() => window.open(item.link, "_blank")}
                              className="cursor-pointer bg-card hover:bg-card/80 border border-border/50 hover:border-pink-500/30 shadow-sm hover:shadow-lg transition-all h-[220px] flex flex-col group"
                            >
                              <CardHeader className="flex flex-row items-start gap-3 p-4 pb-2">
                              ...
                              <CardContent className="flex-1 flex flex-col justify-between p-4 pt-0">
                                ...
                                <div className="space-y-2 mt-2">
                                  {item.matchReason && (
                                    <Badge className="text-[10px] bg-pink-500/10 text-pink-600 border-0">
                                      {item.matchReason}
                                    </Badge>
                                  )}
                                  <div className="flex items-center justify-between">
                  ...
                  <div className="text-center py-16 bg-muted/30 rounded-2xl">
                    ...
                    <p className="text-muted-foreground text-sm max-w-md mx-auto">
                      Complete your onboarding to get personalized blog and research paper recommendations!
                    </p>
                  </div>
                )}
              </section>
                      ...
                      >
                        ...
                        >
                          <CardHeader className="flex flex-row items-start gap-3 p-4 pb-2">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-1">
                                <Badge variant="outline" className="text-[10px] capitalize border-teal-500/30 text-teal-600">
